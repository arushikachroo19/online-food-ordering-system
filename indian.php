...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM productss WHERE code='$code'");
...
<td style="background-color:#333; padding: 14px 16px;" ><font color=white size=5><center>Indian Cuisine(Veg & Non-veg)</center></font></td>
