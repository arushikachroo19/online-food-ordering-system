...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM chines WHERE code='$code'");
...
<td style="background-color:#333; padding: 14px 16px;" ><font color=white size=5><center>Chines Cuisine(Veg & Non-veg)</center></font></td>
